    ...
    <footer className="py-12 px-6 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0f0f1a] transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold mb-4 text-[#1a202c] dark:text-white">Tautan Cepat</h4>
            <ul className="space-y-2">
              {['Tentang', 'Proyek', 'Sertifikat', 'Kontak'].map((link) => (
                <li key={link}>
                  <button
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-semibold mb-4 text-[#1a202c] dark:text-white">Kontak</h4>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            {socialLinks.map((link) => (
              ...
              >
                {link.icon === 'github' && (
                  <svg className="w-4 h-4 text-[#1a202c] dark:text-white" fill="currentColor" viewBox="0 0 24 24">
